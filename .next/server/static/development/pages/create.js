...
const Question = () => {
  ...
  const handleNumOptions = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(option => setNumOptions(option), []);
  const handleQuestion = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(question => setQuestion(question), []);
  const handleSubmit = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(_event => setUrl(''), []);
