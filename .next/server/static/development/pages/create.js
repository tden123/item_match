...
const Question = () => {
  ...
  const handleAddOption = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(() => {
    if (numOptions > 4) {
      setNumOptions(4), [];
  ...
  const handleRemoveOption = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(() => {
    if (numOptions > 4) {
      setNumOptions(4), [];
    } else if (numOptions < 2) {
      setNumOptions(2), [];
