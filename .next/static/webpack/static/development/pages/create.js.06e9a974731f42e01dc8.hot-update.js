...
var Question = function Question() {
          ...
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.async(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.awrap(setOpen(true));

                case 2:
                  _context.next = 4;
                  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.awrap(setCurrOption(item));
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_9__["Fragment"], null, __jsx(_shopify_app_bridge_react__WEBPACK_IMPORTED_MODULE_10__["ResourcePicker"], {
    ...
    showVariants: false,
    open: open,
    onSelection: function _callee2(resources) {
      var newItem;
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.async(function _callee2$(_context2) {
        while (1) {
...
//# sourceMappingURL=create.js.06e9a974731f42e01dc8.hot-update.js.map