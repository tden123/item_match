...
var Question = function Question() {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])(1),
      numOptions = _useState3[0],
      setNumOptions = _useState3[1];

  var handleNumOptions = Object(react__WEBPACK_IMPORTED_MODULE_8__["useCallback"])(function (option) {
    if (option > 4) {
      setNumOptions(4), [];
    } else {
  ...
  var handleChange = Object(react__WEBPACK_IMPORTED_MODULE_8__["useCallback"])(function (event) {
    return setOptions(_objectSpread({}, options, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])({}, event.target.name, event.target.value)));
  });
  ...
  }), displayOptions(lodash__WEBPACK_IMPORTED_MODULE_10___default.a.range(1, _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_6___default()(numOptions, 10) + 1)))));
};
...
//# sourceMappingURL=create.js.414d4d518f549f0319a5.hot-update.js.map